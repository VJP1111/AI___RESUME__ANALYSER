...
def display_analysis_results(analysis: Dict[str, Any], candidate_name: str):
    ...
    fig_gauge, fig_pie = create_advanced_visualizations(analysis)
...
def save_analysis(user_id: int, analysis: Dict[str, Any], candidate_name: str, job_title: str):
    ...
    try:
        ...
        cursor.execute("""
            INSERT INTO ai_analyses (user_id, candidate_name, job_title, overall_match_score,
                                   extracted_skills, matching_skills, missing_skills, ai_insights, enhancement_suggestions)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        """, (
